...
class StableDiffusion:
    ...
    def generate(
        ...
        momentum1 = tf.zeros_like(latent) 
        ...
        for index, timestep in progbar:
            ...
            latent_temp, pred_x0 = self.get_x_prev_and_pred_x0(
            ...
            if input_mask is not None and input_image is not None:
                ...
                latent_temp = latent_orgin * latent_mask_tensor + latent_temp * (1- latent_mask_tensor)
            residual =  latent-latent_temp
            if start==True and  beta_1>0.5:
                momentum1=residual
                start = False

            momentum1 = beta_1*momentum1 + (1.-beta_1)*residual
            latent= latent - momentum1
